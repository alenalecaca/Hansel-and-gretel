...
def fct_pause():
    if pause == False and btnp(pyxel.KEY_Q): #and not mort:
        pause = True
        saut = False
    elif pause == True and btnp(pyxel.KEY_Q): #and not mort:
        pause = False
...
def draw(): 
    ...
    # appel de la fonction "draw" du menu: à reporter dans module main
    ...
    elif pause == True: #and mort == False:
        ...
        loc = 0
        for i in str(score):
            if i == "0": pyxel.blt(0+loc, 120, 0, 33, 16, 5, 7, 2)
            elif i == "1": pyxel.blt(0+loc, 120, 0, 39, 16, 4, 7, 2)
            elif i == "2": pyxel.blt(0+loc, 120,0, 44, 16, 4, 7, 2)
            elif i == "3": pyxel.blt(0+loc, 120,0, 33, 24, 4, 7, 2)
            elif i == "4": pyxel.blt(0+loc, 120,0, 39, 24, 4, 7, 2)
            elif i == "5": pyxel.blt(0+loc, 120,0, 44, 24, 4, 7, 2)
            elif i == "6": pyxel.blt(0+loc, 120,0, 49, 16, 4, 7, 2)
            elif i == "7": pyxel.blt(0+loc, 120,0, 57, 16, 4, 7, 2)
            elif i == "8": pyxel.blt(0+loc, 120,0, 49, 24, 4, 7, 2)
            elif i == "9": pyxel.blt(0+loc, 120,0, 57, 24, 4, 7, 2)
            loc += 5
