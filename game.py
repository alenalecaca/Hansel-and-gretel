...
def game_draw(): 
    ...
    if mort:
        ...
        if pyxel.frame_count % 2 == 0:
            pyxel.blt(sorciere_x,sorciere_y,0,0,0,16,16,2)  #1er dessin sorciere
        else:
            pyxel.blt(sorciere_x,sorciere_y,0,16,0,16,16,2)
